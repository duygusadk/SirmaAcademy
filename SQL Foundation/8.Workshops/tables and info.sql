...
--ADD CONSTRAINT fk_paymnent_transaction FOREIGN KEY (transaction_id) REFERENCES Transactions(transaction_id) ON DELETE SET NULL
--GO
CREATE TABLE Transactions ( 
transaction_id INT IDENTITY(1,1) PRIMARY KEY,
supplier_id INT, employee_id INT,
...
VALUES ('Client A', 'clientA@example.com', '123-456-7890', '123 Main St'),
...
VALUES ('Supplier A', 'supplierA@example.com', '123-456-7890', '123 Supply St'),
...
VALUES ('John Doe', 'Accountant', 55000, '2022-05-01', 'Finance'),
...
GO
INSERT INTO Invoices (client_id, issue_date, due_date, amount, tax_rate, vat, discount, currency, status)
VALUES (1, '2024-01-10', '2024-02-10', 1200.50, 10.00, 120.05, 50.00, 'USD', 'Paid'),
...
INSERT INTO Transactions (supplier_id, employee_id, transaction_date, amount, transaction_type , category) 
VALUES (1, 1, '2024-01-25', 500.00, 'Expense', 'Salary'),
...
INSERT INTO Payments (invoice_id, payment_date, amount, payment_method, bank_name, transaction_id)
VALUES (1, '2024-02-05', 1200.50, 'Bank Transfer', 'Bank A', 1),
